...
public class LobbyMenu : MonoBehaviour {
	...
	public static readonly string SceneNameLobby = "Lobby-Scene";
	
	public static readonly string SceneNameRoom = "Room-Scene";
	...
	void GUI_Lobby()
	{
		...
		{
			PhotonNetwork.CreateRoom(this.roomName, true, true, 8);
		}
